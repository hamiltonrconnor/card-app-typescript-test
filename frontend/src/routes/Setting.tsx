...
import {useState, useContext,createContext,ChangeEvent, MouseEvent} from 'react'
...
export default function Setting(){
    ...
    return(
        <div className="grid grid-cols-2 gap-x-5">
            <label className="toggleDarkBtn justify-self-end text-black dark:text-white">
        Light/Dark Mode   
        </label>        
   ...
   type="checkbox" onClick={() => toggleDarkMode(darkMode)} />
